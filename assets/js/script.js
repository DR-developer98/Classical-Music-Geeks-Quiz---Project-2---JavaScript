document.addEventListener("DOMContentLoaded", function () {
  ...
  const easyQuestionsList = [
    ...
    {
      questionText: "Who composed the 'Symphony No. 9 in D minor' (Ode to Joy)?",
      answer1: "Ludwig van Beethoven", // correct
      answer2: "Johannes Brahms",
      answer3: "Franz Schubert",
  ...
  const mediumQuestionsList = [
    ...
    {
      questionText: "Which instrument did Frederic Chopin primarily compose for?",
      answer1: "Violin",
    ...
    {
      questionText: "Which composer is associated with the term 'Impressionism'?",
    ...
    {
      questionText: "The 'Rite of Spring' caused a riot at its premiere in 1913. Who composed it?",
    ...
    {
      questionText: "Which composer famously began losing his hearing in his late 20s?",
      answer1: "Ludwig van Beethoven", // correct
      answer2: "Wolfgang Amadeus Mozart",
      answer3: "Franz Schubert",
      answer4: "Joseph Haydn"
    ...
    {
      questionText: "The 'Carnival of the Animals' is a work by which French composer?",
      answer1: "Camille Saint-Saëns", // correct
      answer2: "Claude Debussy",
      answer3: "Maurice Ravel",
    ...
    {
      questionText: "Which symphony is often referred to as 'Beethoven's Tenth'?",
    ...
    {
      questionText: "Which composer was a child prodigy and wrote his first symphony at age 8?",
      answer1: "Franz Schubert",
      answer2: "Ludwig van Beethoven",
      answer3: "Wolfgang Amadeus Mozart", // correct
      answer4: "Felix Mendelssohn"
    ...
    {
      questionText: "The 'Brandenburg Concertos' were dedicated to which patron?",
    ...
    {
      questionText: "The 'Planets' suite by Gustav Holst contains how many movements?",
      answer1: "5",
      answer2: "7", // correct
      answer3: "9",
      answer4: "11"
    ...
    {
      questionText: "The 'Enigma Variations' are a set of variations by which composer?",
    ...
    {
      questionText: "The 'Symphonie fantastique' by Hector Berlioz is based on what?",
  ...
  const hardQuestionsList = [
    {
      questionText: "Which composer is known for the invention of the twelve-tone technique?",
    ...
    {
      questionText: "The opera 'Boris Godunov' was composed by which Russian composer?",
    ...
    {
      questionText: "Which opera by Richard Wagner is part of the 'Ring Cycle'?",
    ...
    {
      questionText: "Which composer is famous for his late-Romantic symphonies and song cycles?",
    ...
    {
      questionText: "The 'Concerto for Orchestra' was composed by which Hungarian composer?",
    ...
    {
      questionText: "The 'War Requiem' was composed by which 20th-century British composer?",
    ...
    {
      questionText: "Who composed the opera 'Lady Macbeth of the Mtsensk District'?",
    ...
    },
  {
    ...
    {
      questionText: "Which composer wrote the 'Symphony No. 7 in C Major, Op. 60' often called the 'Leningrad Symphony'?",
      answer1: "Dmitri Shostakovich", // correct
      answer2: "Sergei Prokofiev",
      answer3: "Igor Stravinsky",
      answer4: "Nikolai Rimsky-Korsakov"
    ...
    {
      questionText: "Which late Romantic composer is known for his tone poems such as 'Also sprach Zarathustra' and 'Don Juan'?",
    ...
    {
      questionText: "The 'Symphony No. 8 in E-flat major' is often referred to as the 'Symphony of a Thousand'. Who composed it?",
      answer1: "Gustav Mahler", // correct
      answer2: "Anton Bruckner",
      answer3: "Richard Strauss",
      answer4: "Johannes Brahms"
    ...
    {
      questionText: "Who composed the 'Symphony No. 3 in C minor, Op. 78', known as the 'Organ Symphony'?",
      answer1: "Camille Saint-Saëns", // correct
    ...
    {
      questionText: "Which composer is known for his cycle of piano works titled 'Miroirs'?",
      answer1: "Claude Debussy",
      answer2: "Erik Satie",
      answer3: "Maurice Ravel",
  },
  {
      questionText: "The 'Variations on a Theme of Paganini' is a work for piano composed by?",
      answer1: "Franz Liszt",
    ...
    {
      questionText: "The opera 'Peter Grimes' was composed by which 20th-century composer?",
    ...
    {
      questionText: "Who composed the 'Symphony No. 9 in D minor, Op. 125', also known as the 'Choral Symphony'?",
      answer1: "Johannes Brahms",
    ...
    {
      questionText: "The 'Symphonie espagnole' is a violin concerto by which composer?",
    ...
    {
      questionText: "The opera 'Die Meistersinger von Nürnberg' was written by?",
